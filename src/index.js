...
<section id="care"><div class="wrap"><p class="eyebrow"><span class="eyebrow__k">見</span> Before you run</p><div class="plate"><h2 class="stmt">Read it before you trust it.</h2><p class="entry__note">These tools can make system-wide changes. Review the source and understand the requested privileges before running them.</p><div class="readout readout--rows"><span><span class="prompt">$ </span><span class="hl">curl -fsSL https://${DOMAIN}/</span><span class="rot" id="rot2"><span class="rot__t">${sample}</span></span><span class="comment"> # read it</span></span><span><span class="prompt">$ </span><span class="hl">curl -fsSL https://${DOMAIN}/</span><span class="rot" id="rot3"><span class="rot__t">${sample}</span></span><span class="hl"> | sh</span><span class="comment"> # run it</span></span></div></div></div></section>
</main>
