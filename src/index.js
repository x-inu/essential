...
.command-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:1rem;align-items:baseline}.command-row__code{min-width:0;white-space:nowrap;overflow-x:auto}.readout--rows .rot{min-width:0}
